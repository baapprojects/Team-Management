...
?>
<br><br>
ENTER THE PROJECT NAME TO GENERATE REPORT <input type="text" name="name"><br><br><br>
<button class="button button1" type="submit" formaction="teamreport.php">GENERATE REPORT</button></BR></BR></BR>
</center>
</form>
</body>
</html>
